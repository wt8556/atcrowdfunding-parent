...
<div class="container">
    ...
    <form method="post"  class="form-signin" role="form" action="${PATH}/admin/login">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
        <div style="color: #CC0000">${errorMsg}</div>
        <div class="form-group has-success has-feedback">
            <input name="loginacct" type="text" value="" class="form-control" id="inputSuccess4" placeholder="请输入登录账号" autofocus>
