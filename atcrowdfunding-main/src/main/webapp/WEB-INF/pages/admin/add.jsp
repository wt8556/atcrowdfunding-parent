            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="${PATH}/admin/save" method="post">
                        <div style="color: red";>${saveErrorMsg}</div>

                        <%
                            session.removeAttribute("saveErrorMsg");
                        %>
                        ...
                        <div class="form-group">
                            ...
                            <input name="userpwd" type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" value="@123.com" type="email" class="form-control" id="exampleInputEmail1" placeholder="请输入邮箱地址">
